...
In figure \ref{fig:ffn}, the performances of all optimized FFN are plotted. The red line represents the average of all optimized FFN, which performs better than the buy-and-hold in black. In addition, it is worth noting that all realizations of the FFN have a performance better than zero. This is most likely due to the upward trend of the ETH. 
